	...
	if DoesEntityExist(deliveryPed) and not IsEntityDead(deliveryPed) then
		...
		if HasStolenGoods() then
			...
			if OxyRun then
		        ...
		        elseif exports["np-inventory"]:hasEnoughOfItem("rollcash",10,false) then     
		        ...
		        elseif exports["np-inventory"]:hasEnoughOfItem("markedbills",10,false) then     
		            TriggerEvent("inventory:removeItem","markedbills", 10)   
		            cashPayment = cashPayment + markedbillsprice            
		            TriggerEvent("DoLongHudText","Thanks for the extra sauce!")
				elseif exports["np-inventory"]:hasEnoughOfItem("band",10,false) then     
