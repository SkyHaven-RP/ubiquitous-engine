...
function HardwareStore() {
    var shopItems = [
        ...
        { item_id: "oxygentank", id: 0, name: "Shop", information: "{}", slot: 2, amount: 5 },
        { item_id: "armor", id: 0, name: "Shop", information: "{}", slot: 3, amount: 5 },
        { item_id: "radio", id: 0, name: "Shop", information: "{}", slot: 4, amount: 5 },
        { item_id: "watch", id: 0, name: "Shop", information: "{}", slot: 5, amount: 5 },
        { item_id: "Suitcase", id: 0, name: "Shop", information: "{}", slot: 6, amount: 5 },
        { item_id: "Boombox", id: 0, name: "Shop", information: "{}", slot: 7, amount: 5 },
        { item_id: "Box", id: 0, name: "Shop", information: "{}", slot: 8, amount: 5 },
        { item_id: "DuffelBag", id: 0, name: "Shop", information: "{}", slot: 9, amount: 5 },
        { item_id: "MedicalBag", id: 0, name: "Shop", information: "{}", slot: 10, amount: 5 },
        { item_id: "lockpick", id: 0, name: "Shop", information: "{}", slot: 11, amount: 5 },
        { item_id: "fishingrod", id: 0, name: "Shop", information: "{}", slot: 12, amount: 5 },
        { item_id: "washedpan", id: 0, name: "Shop", information: "{}", slot: 13, amount: 5 },
        { item_id: "pickaxe", id: 0, name: "Shop", information: "{}", slot: 14, amount: 5 },
		{ item_id: "bakingsoda", id: 0, name: "Shop", information: "{}", slot: 15, amount: 5 },
		{ item_id: "glucose", id: 0, name: "Shop", information: "{}", slot: 16, amount: 5 },
...
function GunStore() {
    var shopItems = [
        ...
        { item_id: "137902532", id: 0, name: "Shop", information: "{}", slot: 2, amount: 1 },
...
function lost_mc() {
    var shopItems = [
          { item_id: "324215364", id: 0, name: "craft", information: "{}", slot: 1, amount: 5 },
          { item_id: "-1121678507", id: 0, name: "craft", information: "{}", slot: 2, amount: 5 },
          { item_id: "coke50g", id: 0, name: "craft", information: "{}", slot: 3, amount: 5 },
          { item_id: "1627465347", id: 0, name: "craft", information: "{}", slot: 4, amount: 5 },
          { item_id: "weed5oz", id: 0, name: "craft", information: "{}", slot: 5, amount: 5 },
		  { item_id: "extended_micro", id: 0, name: "craft", information: "{}", slot: 6, amount: 5 },
		  { item_id: "3218215474", id: 0, name: "craft", information: "{}", slot: 7, amount: 5 },
		  { item_id: "extended_sns", id: 0, name: "craft", information: "{}", slot: 8, amount: 5 },
		  { item_id: "pistolammo", id: 0, name: "craft", information: "{}", slot: 9, amount: 5 },
		  { item_id: "subammo", id: 0, name: "craft", information: "{}", slot: 10, amount: 5 },
		  { item_id: "rifleammo", id: 0, name: "craft", information: "{}", slot: 11, amount: 5 },
    ];
    return JSON.stringify(shopItems);
}


function winery_factory() {
    var shopItems = [
          { item_id: "324215364", id: 0, name: "craft", information: "{}", slot: 1, amount: 5 },
          { item_id: "-1121678507", id: 0, name: "craft", information: "{}", slot: 2, amount: 5 },
          { item_id: "coke50g", id: 0, name: "craft", information: "{}", slot: 3, amount: 5 },
...
function Blackmarket() {
    var shopItems = [
        ...
        { item_id: "-1357824103", id: 0, name: "craft", information: "{}", slot: 7, amount: 5 },
		{ item_id: "-1074790547", id: 0, name: "craft", information: "{}", slot: 8, amount: 5 },
		{ item_id: "-270015777", id: 0, name: "craft", information: "{}", slot: 9, amount: 5 },
		{ item_id: "2144741730", id: 0, name: "craft", information: "{}", slot: 10, amount: 5 },
		{ item_id: "3231910285", id: 0, name: "craft", information: "{}", slot: 11, amount: 5 },
		{ item_id: "584646201", id: 0, name: "craft", information: "{}", slot: 12, amount: 5 },
		{ item_id: "1649403952", id: 0, name: "craft", information: "{}", slot: 13, amount: 5 },
		{ item_id: "extended_ap", id: 0, name: "craft", information: "{}", slot: 14, amount: 5 },
		{ item_id: "silencer_l2", id: 0, name: "craft", information: "{}", slot: 15, amount: 5 },
		{ item_id: "silencer_s2", id: 0, name: "craft", information: "{}", slot: 16, amount: 5 },
		{ item_id: "741814745", id: 0, name: "craft", information: "{}", slot: 17, amount: 5 },
		{ item_id: "-1075685676", id: 0, name: "craft", information: "{}", slot: 18, amount: 5 },
        	{ item_id: "heavyammo", id: 0, name: "craft", information: "{}", slot: 19, amount: 5 },
		{ item_id: "coke50g", id: 0, name: "craft", information: "{}", slot: 20, amount: 5 },
		{ item_id: "thermite", id: 0, name: "craft", information: "{}", slot: 21, amount: 5 },
		{ item_id: "-771403250", id: 0, name: "craft", information: "{}", slot: 22, amount: 5 },
